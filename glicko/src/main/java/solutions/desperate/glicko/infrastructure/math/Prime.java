...
public class Prime
{
     ...
     */
    private static Vector<BigInteger> a = new Vector<>();

    /** The maximum integer covered by the high end of the list.
     */
    private static BigInteger nMax = new BigInteger("-1");
     ...
     * @since 2010-02-25
     */
    private boolean isSPP(final BigInteger n, final BigInteger a)
    {
     ...
     * @author Richard J. Mathar
     */
    private int millerRabin(final BigInteger n)
    {
    ...
    private void growto(BigInteger n)
    {
        while(nMax.compareTo(n) < 0)
        {
            ...
            for (BigInteger anA : a) {
                 ...
                 */
                if (anA.multiply(anA).compareTo(nMax) > 0)
                    break;
                 ...
                 */
                if (nMax.remainder(anA).compareTo(BigInteger.ZERO) == 0) {
                    isp = false;
                    break;
                }
            }
