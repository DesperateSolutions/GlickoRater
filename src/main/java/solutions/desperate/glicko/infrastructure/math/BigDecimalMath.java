 ...
 * @since 2009-05-22
 */
@SuppressWarnings({"BigDecimalMethodWithoutRoundingCalled", "SameParameterValue", "UnusedAssignment", "SuspiciousNameCombination"})
public class BigDecimalMath {
     ...
     */
    private static BigDecimal E = new BigDecimal("2.71828182845904523536028747135266249775724709369995957496696762772407663035354" +
     ...
     */
    private static BigDecimal GAMMA = new BigDecimal("0.577215664901532860606512090082402431" +
     ...
     * @since 2009-06-01
     */
    private static BigDecimal sin(final BigDecimal x) {
        if (x.compareTo(BigDecimal.ZERO) < 0)
     ...
     */
    private static BigDecimal cosh(final BigDecimal x) {
        if (x.compareTo(BigDecimal.ZERO) < 0)
     ...
     * @since 2009-08-19
     */
    private static BigDecimal sinh(final BigDecimal x) {
        if (x.compareTo(BigDecimal.ZERO) < 0)
     ...
     * @since 2009-08-19
     */
    private static BigDecimal pochhammer(final BigDecimal x, final int n) {
        /* reduce to interval near 1.0 with the functional relation, Abramowitz-Stegun 6.1.33
         */
        if (n < 0)
     ...
     * @since 2009-08-20
     */
    private static double zeta1(final int n) {
